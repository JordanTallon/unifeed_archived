...
- [7. Deployment and Testing](#7-deployment-and-testing)
   ...
   * [7.2. Proxy Dockerfile](#72-proxy-dockerfile)
      + [7.2.1. Docker-Compose](#721-docker-compose)
   * [7.3. CI/CD Pipeline](#73-cicd-pipeline)
   * [7.4. Unit Tests](#74-unit-tests)
      + [7.4.1. Accounts Tests](#741-accounts-tests)
      + [7.4.2. AI Analysis Tests](#742-ai-analysis-tests)
      + [7.4.3. Articles  Tests](#743-articles-tests)
      + [7.4.4. Feeds Tests](#744-feeds-tests)
